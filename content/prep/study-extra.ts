...
export const cardsExtra: StudyCard[] = [
  ...
  { id: "cx-paimon", competitorId: "paimon", topic: "analytics-formats", q: "Why watch Apache Paimon?", a: "It's the table format converging fastest on Lance: column evolution without rewrites, blob files, a vector index, and Lance as a supported file format. Its docs recommend Lance for ML." },
  ...
  { id: "cx-catalogs-lance", competitorId: "catalogs", topic: "catalogs", q: "Which catalogs can see Lance tables?", a: "Gravitino natively, as a Lance REST namespace server. Polaris through generic tables. Unity Catalog through an external-table mapping." },
  ...
  { id: "cx-paimon-answer", competitorId: "paimon", topic: "analytics-formats", q: "Paimon has blobs, vectors and column evolution. Isn't it Lance plus streaming?", a: "It's converging on Lance's feature list and recommends Lance files for ML. In Lance these are native defaults with a wider AI engine ecosystem; in Paimon they're newer opt-in modes on a Flink-first format." },
]
...
export const quizExtra: QuizItem[] = [
  ...
  { id: "qx-paimon", competitorId: "paimon", topic: "analytics-formats", q: "Which file format do Paimon's docs recommend for ML workloads?", options: ["Parquet", "ORC", "Lance", "Avro"], answer: 2, why: "Paimon supports several formats and recommends Lance for ML, which is an endorsement worth quoting." },
